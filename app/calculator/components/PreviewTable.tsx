      ...
      <table className="min-w-full text-sm border border-gray-300">
        <thead className="sticky top-0 bg-gray-100 border-b border-gray-300">
          <tr className="text-gray-700 font-semibold">
            ...
            <th className="px-3 py-2 border-r">Коробок</th>
          ...
          {rows.map((r, i) => {
            ...
            return (
              ...
              >
                ...
                <td className="px-3 py-2 border-r text-right text-gray-800">{r.weight}</td>
                <td className="px-3 py-2 border-r text-right text-gray-800">{r.box_count}</td>
                <td className="px-3 py-2 text-red-600 font-medium">{r._parse_error || ""}</td>
              </tr>
            );
          })}
        </tbody>
